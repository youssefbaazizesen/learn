...
class SocialIns extends StatefulWidget {
  const SocialIns(this.setLocale, {super.key});
  final void Function(Locale locale) setLocale;

  @override
  State<SocialIns> createState() => _SocialIns();
}

class _SocialIns extends State<SocialIns> {
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            title: Row(
              ...
              children: [
                AutoSizeText(
                  AppLocalizations.of(context)!.social_ins,
              ...
              Center(
                ...
                child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: AppLocalizations.of(context)!.socialInsINPT,
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            AppLocalizations.of(context)!.whoPay,
                            style: const TextStyle(
                                fontFamily: 'Lato',
                                fontSize: 22,
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            AppLocalizations.of(context)!.monthlymaxmin,
                            style: const TextStyle(
                                fontFamily: 'Lato',
                                fontSize: 24,
                                fontWeight: FontWeight.bold),
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            AppLocalizations.of(context)!.monthlysub,
                            style: const TextStyle(
                                fontFamily: 'Lato',
                                fontSize: 22,
                                fontWeight: FontWeight.w600),
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            AppLocalizations.of(context)!.totalcont,
                            style: const TextStyle(
                                fontFamily: 'Lato',
                                fontSize: 22,
                                fontWeight: FontWeight.w600,
