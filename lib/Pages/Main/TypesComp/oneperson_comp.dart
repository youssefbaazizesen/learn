...
class Oneperson extends StatefulWidget {
  const Oneperson(this.setLocale, {super.key});
            ...
            title: Row(
              ...
              children: [
                ConstrainedBox(
                  ...
                  child: AutoSizeText(AppLocalizations.of(context)!.onePerson,
                  ...
                  child: Card(
                    ...
                    child: ConstrainedBox(
                      ...
                      child: Column(children: [
                        ...
                        Text(
                          AppLocalizations.of(context)!.opParTitle,
                          maxLines: 2,
                        ...
                        SizedBox(
                            width: 310,
                            child: Text(
                              AppLocalizations.of(context)!.opParagraph,
                              maxLines: 39,
                              overflow: TextOverflow.ellipsis,
                              softWrap: false,
                              style: const TextStyle(
                  ...
                  child: Card(
                    ...
                    child: ConstrainedBox(
                      ...
                      child: Column(children: [
                        const SizedBox(height: 25),
                        Text(
                          AppLocalizations.of(context)!.opAdvantagesTitle,
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                          softWrap: false,
                          style: const TextStyle(
                        ...
                        SizedBox(
                            width: 290,
                            child: Text(
                              AppLocalizations.of(context)!.opAdvantages,
                              maxLines: 39,
                              overflow: TextOverflow.ellipsis,
                              softWrap: false,
                              style: const TextStyle(
                  ...
                  child: Card(
                    ...
                    child: ConstrainedBox(
                      ...
                      child: Column(children: [
                        const SizedBox(height: 25),
                        Text(
                          AppLocalizations.of(context)!.opEstablishTitle,
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                          softWrap: false,
                          style: const TextStyle(
                        ...
                        SizedBox(
                            width: 290,
                            child: Text(
                              AppLocalizations.of(context)!.opEstablish,
                              maxLines: 60,
                              overflow: TextOverflow.ellipsis,
                              softWrap: false,
                              style: const TextStyle(
