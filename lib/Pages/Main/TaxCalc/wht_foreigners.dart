...
class WhtFor extends StatefulWidget {
  const WhtFor(this.setLocale, {super.key});
              ...
              Center(
                ...
                child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: AppLocalizations.of(context)!.whtForINPT,
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            AppLocalizations.of(context)!.ammount,
                            style: const TextStyle(
                                fontFamily: 'Lato',
                                fontSize: 22,
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            "${AppLocalizations.of(context)!.wht} (20%)",
                            style: const TextStyle(
                                fontFamily: 'Lato',
                                fontSize: 22,
                                fontWeight: FontWeight.w600,
