...
class Takafulcont extends StatefulWidget {
  const Takafulcont(this.setLocale, {super.key});
...
class _Takafulcont extends State<Takafulcont> {
  final extInputVal = TextEditingController();
            ...
            title: Row(
              ...
              children: [
                ConstrainedBox(
                  ...
                  child: AutoSizeText(AppLocalizations.of(context)!.takaful,
              ...
              Center(
                ...
                child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: AppLocalizations.of(context)!.takafulINPT,

                      suffixIcon: IconButton(
                        onPressed: () => extInputVal.clear(),
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            AppLocalizations.of(context)!.annualGrosssales,
                            style: const TextStyle(
                                fontFamily: 'Lato',
                                fontSize: 22,
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            AppLocalizations.of(context)!.contrubutionTakaful,
                            style: const TextStyle(
                                fontFamily: 'Lato',
                                fontSize: 22,
                                fontWeight: FontWeight.w600,
