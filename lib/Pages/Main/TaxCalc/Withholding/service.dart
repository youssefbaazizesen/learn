...
class ServcTax extends StatefulWidget {
  const ServcTax(this.setLocale, {super.key});
              ...
              Center(
                ...
                child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: AppLocalizations.of(context)!.serviceINPT,
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            AppLocalizations.of(context)!.servcValue,
                            style: const TextStyle(
                                fontFamily: 'Lato',
                                fontSize: 22,
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            "${AppLocalizations.of(context)!.wht} (3%)",
                            style: const TextStyle(
                                fontFamily: 'Lato',
                                fontSize: 22,
                                fontWeight: FontWeight.w600,
